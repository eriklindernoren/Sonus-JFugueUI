...
import projekt.sonus.grid.GridListener;
import projekt.sonus.grid.GridObserver;
...
public final class Grid extends JPanel implements GridObserver {

    private List<Point> fillCells;
    private List<Color> cellColor;
    private List<String> icons;
    private final static int LIST_SIZE = 200;
    ...
    public void registerGridListener(GridListener listener) {
    ...
    int getSoundCountPerRow(int channel, int times) {
        switch (channel) {
            ...
            case 8:
                gridGrabber.setChannelCount8(gridGrabber.getChannelCount8() + times);
                return gridGrabber.getChannelCount8() - times;
        }
        return 0;
    }
